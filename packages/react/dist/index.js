...
__export(index_exports, {
  ...
  Duck: () => Duck,
  Emoji: () => Emoji,
  EmojiErrorBoundary: () => EmojiErrorBoundary,
  ...
  FrogCry: () => FrogCry,
  FrogDance: () => FrogDance,
  FrogExhausted: () => FrogExhausted,
  FrogGood: () => FrogGood,
  FrogGreat: () => FrogGreat,
  FrogHappy: () => FrogHappy,
  FrogLove: () => FrogLove,
  FrogLow: () => FrogLow,
  FrogNatural: () => FrogNatural,
  Ghost: () => Ghost,
  Gift: () => Gift,
  Handshake: () => Handshake,
  Happy: () => Happy,
...
// ../core/src/emojis/cherry-blossom.ts
var CherryBlossom_DATA = {
  name: "cherry-blossom",
...
// ../core/src/emojis/fingers-crossed.ts
var FingersCrossed_DATA = {
...
// ../core/src/emojis/frog-coffee.ts
var FrogCoffee_DATA = {
  name: "frog-coffee",
...
// ../core/src/emojis/frog-exhausted.ts
var FrogExhausted_DATA = {
  name: "frog-exhausted",
...
// ../core/src/emojis/frog-good.ts
var FrogGood_DATA = {
  name: "frog-good",
  label: "Good Frog",
  category: "animals",
  keywords: ["frog", "good", "content", "relaxed", "chill", "thumbsup", "nice"],
  unicode: "\u{1F438}",
  version: "1.1.0",
  svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="100%" height="100%" fill="none"><path d="M24 64 C24 44 32 38 42 38 C48 38 52 42 56 46 C60 46 68 46 72 46 C76 42 80 38 86 38 C96 38 104 44 104 64 C104 90 92 108 64 108 C36 108 24 90 24 64 Z" fill="#AACC00" stroke="#1E1F24" stroke-width="4.5" stroke-linejoin="round"/><path d="M40 82 C40 70 50 64 64 64 C78 64 88 70 88 82 C88 98 78 104 64 104 C50 104 40 98 40 82 Z" fill="#E9F5DB"/><circle cx="44" cy="38" r="14" fill="#AACC00" stroke="#1E1F24" stroke-width="4"/><circle cx="44" cy="38" r="6.5" fill="#1E1F24"/><circle cx="46" cy="36" r="2.2" fill="#FFFFFF"/><path d="M32 34 C36 30 52 30 56 34" stroke="#1E1F24" stroke-width="3.5" stroke-linecap="round"/><circle cx="84" cy="38" r="14" fill="#AACC00" stroke="#1E1F24" stroke-width="4"/><circle cx="84" cy="38" r="6.5" fill="#1E1F24"/><circle cx="86" cy="36" r="2.2" fill="#FFFFFF"/><path d="M72 34 C76 30 92 30 96 34" stroke="#1E1F24" stroke-width="3.5" stroke-linecap="round"/><ellipse cx="34" cy="68" rx="8" ry="5" fill="#FF8BA7" fill-opacity="0.75"/><ellipse cx="94" cy="68" rx="8" ry="5" fill="#FF8BA7" fill-opacity="0.75"/><path d="M46 72 C52 82 76 82 82 72" stroke="#1E1F24" stroke-width="4" stroke-linecap="round" fill="none"/><path d="M24 72 C18 68 16 58 20 52 C24 48 26 54 24 60" stroke="#1E1F24" stroke-width="3.5" stroke-linecap="round" fill="#AACC00"/><path d="M18 52 C16 46 20 42 24 44 C28 46 26 52 22 54" stroke="#1E1F24" stroke-width="2.5" stroke-linecap="round" fill="#AACC00"/><path d="M104 72 C110 70 114 64 112 58 C110 54 106 58 104 64" stroke="#1E1F24" stroke-width="3.5" stroke-linecap="round" fill="#AACC00"/></svg>',
  viewBox: "0 0 128 128"
};

// ../core/src/emojis/frog-great.ts
var FrogGreat_DATA = {
  name: "frog-great",
  label: "Great Frog",
  category: "animals",
...
// ../core/src/emojis/frog-natural.ts
var FrogNatural_DATA = {
  name: "frog-natural",
  label: "Natural Frog",
  category: "animals",
...
// ../core/src/emojis/heart-hands.ts
var HeartHands_DATA = {
  name: "heart-hands",
  label: "Heart Hands",
  category: "gestures",
...
// ../core/src/emojis/pointing-right.ts
var PointingRight_DATA = {
  name: "pointing-right",
...
// ../core/src/emojis/rolling-eyes.ts
var RollingEyes_DATA = {
  name: "rolling-eyes",
  label: "Rolling Eyes",
  category: "reactions",
...
// ../core/src/emojis/sweat-smile.ts
var SweatSmile_DATA = {
  name: "sweat-smile",
...
// ../core/src/emojis/thumbs-down.ts
var ThumbsDown_DATA = {
  name: "thumbs-down",
  label: "Thumbs Down",
  category: "gestures",
...
// src/EmojiErrorBoundary.tsx
var import_react2 = require("react");
var import_jsx_runtime2 = require("react/jsx-runtime");
var EmojiErrorBoundary = class extends import_react2.Component {
  constructor(props) {
    super(props);
    ...
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("rect", { width: "128", height: "128", rx: "28", fill: "#FEF2F2", stroke: "#FECACA", strokeWidth: "4" }),
...
function sanitizeSvg(svg) {
  return svg.replace(/<script[\s\S]*?<\/script>/gi, "").replace(/<foreignObject[\s\S]*?<\/foreignObject>/gi, "").replace(/on[a-z]+\s*=\s*["'][^"']*["']/gi, "").replace(/on[a-z]+\s*=\s*[\s\S]*?>/gi, "").replace(/data:text\/html[\s\S]*?/gi, "").replace(/javascript\s*:/gi, "");
}
function getSvgInner(svgContent) {
  const match = svgContent.match(/<svg[^>]*>([\s\S]*?)<\/svg>/i);
  return match ? match[1] : svgContent;
}
var Emoji = (0, import_react3.forwardRef)(function Emoji2({
  name,
  size,
  width,
  height,
  ...
  if (!emoji) {
    ...
    if (context.fallback !== void 0) {
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: context.fallback });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "svg",
      {
        ...
        ...restProps,
        children: [
          title && !isAriaHidden && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("title", { children: title }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("rect", { width: "128", height: "128", rx: "28", fill: "#F3F4F6", stroke: "#E5E7EB", strokeWidth: "4" }),
...
var SafeEmoji = (0, import_react3.forwardRef)(function SafeEmoji2(props, ref) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(EmojiErrorBoundary, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Emoji, { ref, ...props }) });
});
...
var Angel = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "angel", ref, ...props });
});
Angel.displayName = "Angel";
var Angry = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "angry", ref, ...props });
});
Angry.displayName = "Angry";
var Applause = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "applause", ref, ...props });
});
Applause.displayName = "Applause";
var Avocado = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "avocado", ref, ...props });
});
Avocado.displayName = "Avocado";
var Balloon = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "balloon", ref, ...props });
});
Balloon.displayName = "Balloon";
var Bear = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "bear", ref, ...props });
});
Bear.displayName = "Bear";
var Boba = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "boba", ref, ...props });
});
Boba.displayName = "Boba";
var Bunny = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "bunny", ref, ...props });
});
Bunny.displayName = "Bunny";
var Cake = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "cake", ref, ...props });
});
Cake.displayName = "Cake";
var CatCry = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "cat-cry", ref, ...props });
});
CatCry.displayName = "CatCry";
var CatHappy = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "cat-happy", ref, ...props });
});
CatHappy.displayName = "CatHappy";
var CatLove = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "cat-love", ref, ...props });
});
CatLove.displayName = "CatLove";
var Celebrate = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "celebrate", ref, ...props });
});
Celebrate.displayName = "Celebrate";
var CherryBlossom = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "cherry-blossom", ref, ...props });
});
CherryBlossom.displayName = "CherryBlossom";
var Clown = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "clown", ref, ...props });
});
Clown.displayName = "Clown";
var Coffee = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "coffee", ref, ...props });
});
Coffee.displayName = "Coffee";
var Confused = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "confused", ref, ...props });
});
Confused.displayName = "Confused";
var Cool = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "cool", ref, ...props });
});
Cool.displayName = "Cool";
var Cry = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "cry", ref, ...props });
});
Cry.displayName = "Cry";
var CutePoop = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "cute-poop", ref, ...props });
});
CutePoop.displayName = "CutePoop";
var Devil = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "devil", ref, ...props });
});
Devil.displayName = "Devil";
var Diamond = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "diamond", ref, ...props });
});
Diamond.displayName = "Diamond";
var Dizzy = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "dizzy", ref, ...props });
});
Dizzy.displayName = "Dizzy";
var DogPuppy = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "dog-puppy", ref, ...props });
});
DogPuppy.displayName = "DogPuppy";
var Drool = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "drool", ref, ...props });
});
Drool.displayName = "Drool";
var Duck = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "duck", ref, ...props });
});
Duck.displayName = "Duck";
var Excited = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "excited", ref, ...props });
});
Excited.displayName = "Excited";
var FingersCrossed = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "fingers-crossed", ref, ...props });
});
FingersCrossed.displayName = "FingersCrossed";
var Fire = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "fire", ref, ...props });
});
Fire.displayName = "Fire";
var FistBump = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "fist-bump", ref, ...props });
});
FistBump.displayName = "FistBump";
var FrogCoffee = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "frog-coffee", ref, ...props });
});
FrogCoffee.displayName = "FrogCoffee";
var FrogCry = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "frog-cry", ref, ...props });
});
FrogCry.displayName = "FrogCry";
var FrogDance = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "frog-dance", ref, ...props });
});
FrogDance.displayName = "FrogDance";
var FrogExhausted = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "frog-exhausted", ref, ...props });
});
FrogExhausted.displayName = "FrogExhausted";
var FrogGood = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "frog-good", ref, ...props });
});
FrogGood.displayName = "FrogGood";
var FrogGreat = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "frog-great", ref, ...props });
});
FrogGreat.displayName = "FrogGreat";
var FrogHappy = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "frog-happy", ref, ...props });
});
FrogHappy.displayName = "FrogHappy";
var FrogLove = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "frog-love", ref, ...props });
});
FrogLove.displayName = "FrogLove";
var FrogLow = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "frog-low", ref, ...props });
});
FrogLow.displayName = "FrogLow";
var FrogNatural = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "frog-natural", ref, ...props });
});
FrogNatural.displayName = "FrogNatural";
var Ghost = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "ghost", ref, ...props });
});
Ghost.displayName = "Ghost";
var Gift = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "gift", ref, ...props });
});
Gift.displayName = "Gift";
var Handshake = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "handshake", ref, ...props });
});
Handshake.displayName = "Handshake";
var Happy = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "happy", ref, ...props });
});
Happy.displayName = "Happy";
var HeartHands = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "heart-hands", ref, ...props });
});
HeartHands.displayName = "HeartHands";
var Heart = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "heart", ref, ...props });
});
Heart.displayName = "Heart";
var Hundred = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "hundred", ref, ...props });
});
Hundred.displayName = "Hundred";
var IceCream = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "ice-cream", ref, ...props });
});
IceCream.displayName = "IceCream";
var Laugh = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "laugh", ref, ...props });
});
Laugh.displayName = "Laugh";
var Love = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "love", ref, ...props });
});
Love.displayName = "Love";
var MindBlown = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "mind-blown", ref, ...props });
});
MindBlown.displayName = "MindBlown";
var MoneyFace = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "money-face", ref, ...props });
});
MoneyFace.displayName = "MoneyFace";
var Moon = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "moon", ref, ...props });
});
Moon.displayName = "Moon";
var MusicNote = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "music-note", ref, ...props });
});
MusicNote.displayName = "MusicNote";
var Panda = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "panda", ref, ...props });
});
Panda.displayName = "Panda";
var Party = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "party", ref, ...props });
});
Party.displayName = "Party";
var Peace = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "peace", ref, ...props });
});
Peace.displayName = "Peace";
var Piggy = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "piggy", ref, ...props });
});
Piggy.displayName = "Piggy";
var Pizza = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "pizza", ref, ...props });
});
Pizza.displayName = "Pizza";
var Pleading = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "pleading", ref, ...props });
});
Pleading.displayName = "Pleading";
var PointingRight = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "pointing-right", ref, ...props });
});
PointingRight.displayName = "PointingRight";
var Pray = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "pray", ref, ...props });
});
Pray.displayName = "Pray";
var Puke = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "puke", ref, ...props });
});
Puke.displayName = "Puke";
var Rainbow = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "rainbow", ref, ...props });
});
Rainbow.displayName = "Rainbow";
var Ramen = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "ramen", ref, ...props });
});
Ramen.displayName = "Ramen";
var Rocket = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "rocket", ref, ...props });
});
Rocket.displayName = "Rocket";
var RollingEyes = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "rolling-eyes", ref, ...props });
});
RollingEyes.displayName = "RollingEyes";
var Sad = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "sad", ref, ...props });
});
Sad.displayName = "Sad";
var Scream = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "scream", ref, ...props });
});
Scream.displayName = "Scream";
var Shy = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "shy", ref, ...props });
});
Shy.displayName = "Shy";
var Skull = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "skull", ref, ...props });
});
Skull.displayName = "Skull";
var Sleepy = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "sleepy", ref, ...props });
});
Sleepy.displayName = "Sleepy";
var Smug = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "smug", ref, ...props });
});
Smug.displayName = "Smug";
var Sparkles = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "sparkles", ref, ...props });
});
Sparkles.displayName = "Sparkles";
var Starry = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "starry", ref, ...props });
});
Starry.displayName = "Starry";
var Sun = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "sun", ref, ...props });
});
Sun.displayName = "Sun";
var Surprised = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "surprised", ref, ...props });
});
Surprised.displayName = "Surprised";
var SweatSmile = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "sweat-smile", ref, ...props });
});
SweatSmile.displayName = "SweatSmile";
var Thinking = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "thinking", ref, ...props });
});
Thinking.displayName = "Thinking";
var ThumbsDown = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "thumbs-down", ref, ...props });
});
ThumbsDown.displayName = "ThumbsDown";
var ThumbsUp = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "thumbs-up", ref, ...props });
});
ThumbsUp.displayName = "ThumbsUp";
var Wave = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "wave", ref, ...props });
});
Wave.displayName = "Wave";
var Wink = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "wink", ref, ...props });
});
Wink.displayName = "Wink";
var Yawn = (0, import_react4.forwardRef)((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Emoji, { name: "yawn", ref, ...props });
});
