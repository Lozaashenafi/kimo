 ...
 */
declare const SafeEmoji: React.ForwardRefExoticComponent<Omit<EmojiProps, "ref"> & React.RefAttributes<SVGSVGElement>>;
 ...
 */
declare class EmojiErrorBoundary extends Component<EmojiErrorBoundaryProps, EmojiErrorBoundaryState> {
 ...
 * Category: animals
 */
declare const FrogExhausted: React.ForwardRefExoticComponent<Omit<IndividualEmojiProps, "ref"> & React.RefAttributes<SVGSVGElement>>;
/**
 * Good Frog Emoji Component
 * Category: animals
 */
declare const FrogGood: React.ForwardRefExoticComponent<Omit<IndividualEmojiProps, "ref"> & React.RefAttributes<SVGSVGElement>>;
/**
 * Great Frog Emoji Component
 * Category: animals
 */
declare const FrogGreat: React.ForwardRefExoticComponent<Omit<IndividualEmojiProps, "ref"> & React.RefAttributes<SVGSVGElement>>;
/**
 ...
 * Category: animals
 */
declare const FrogLow: React.ForwardRefExoticComponent<Omit<IndividualEmojiProps, "ref"> & React.RefAttributes<SVGSVGElement>>;
/**
 * Natural Frog Emoji Component
 * Category: animals
 */
declare const FrogNatural: React.ForwardRefExoticComponent<Omit<IndividualEmojiProps, "ref"> & React.RefAttributes<SVGSVGElement>>;
/**
...
export { Angel, Angry, Applause, Avocado, Balloon, Bear, Boba, Bunny, Cake, CatCry, CatHappy, CatLove, Celebrate, CherryBlossom, Clown, Coffee, Confused, Cool, Cry, CutePoop, Devil, Diamond, Dizzy, DogPuppy, Drool, Duck, Emoji, type EmojiCategory, type EmojiContextValue, EmojiErrorBoundary, type EmojiName, type EmojiProps, EmojiProvider, type EmojiProviderProps, Excited, FingersCrossed, Fire, FistBump, FrogCoffee, FrogCry, FrogDance, FrogExhausted, FrogGood, FrogGreat, FrogHappy, FrogLove, FrogLow, FrogNatural, Ghost, Gift, Handshake, Happy, Heart, HeartHands, Hundred, IceCream, type IndividualEmojiProps, Laugh, Love, MindBlown, MoneyFace, Moon, MusicNote, Panda, Party, Peace, Piggy, Pizza, Pleading, PointingRight, Pray, Puke, Rainbow, Ramen, Rocket, RollingEyes, Sad, SafeEmoji, Scream, Shy, Skull, Sleepy, Smug, Sparkles, Starry, Sun, Surprised, SweatSmile, Thinking, ThumbsDown, ThumbsUp, Wave, Wink, Yawn, useEmojiContext };
